...
$this->title = 'Поиск по запросу - '.$param;
?>
...
<div class="col-md-9 col-lg-9 col-sm-8 col-xs-12 float-left-style">
    ...
    'links' => isset($this->params['breadcrumbs']) ? $this->params['breadcrumbs'] : [],
        ...
        <section class="htc__product__area shop__page ptb--130 bg__white" style="padding-top: 0;">
            <div class="container">
                <div class="htc__product__container">
                    <?php  if(!empty($subcategories_all)): ?>
                    <div class="row">
                        <div  class=" col-md-9 col-lg-9 col-sm-8 col-xs-12 float-left-style" style="float: left;">
                            <!--div -->
                           
                                <!--div class="" style=" /*display: -webkit-inline-box; */"-->
                                    <!--button data-filter="*"  class="is-checked">Все</button-->
                                    
                                     <?php foreach($subcategories_all as $id => $subcat): ?>
                                     <a style="padding: 8px 15px;
                                    margin-bottom: 10px;
                                    list-style: none;
                                    background-color: #f5f5f5;
                                    border-radius: 4px; display: inline-block;" class="" href="/home/catalog/product/<?= $id ?>"><?= $subcat?></a><!--/p-->
                                    ...
                                    <div class="product__inner">
                                        ...
                                        <div class="product__hover__info">
                                            <ul class="product__action">
                                                <li style="cursor: pointer;" class="buy__now__btn"><a  data-id="<?= $item['id']?>" data-count="1" title="Добавить в корзину"  class="add" id="add"><span class="ti-shopping-cart"></span></a></li>
                                            </ul>
                                        </div>
                                    </div>
